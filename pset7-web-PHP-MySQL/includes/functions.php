<?php
    ...
    function sendemail($email, $values = [])
    {
        // if template exists, render it
        if (file_exists("../emails/$email"))
        {
            ...
            $mail->Username = 'jharvardfinance@gmail.com'; // SMTP username
            $mail->Password = 'crimsoncrimson'; // SMTP password
            $mail->SMTPSecure = 'ssl'; // Enable TLS encryption, ssl also accepted
            $mail->Port = 465; // TCP port to connect to

            $mail->From = 'jharvardfinance@gmail.com';
            $mail->FromName = 'J Harvard Finance';
